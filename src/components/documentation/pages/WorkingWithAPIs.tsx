...
/**
 * Working with APIs documentation page
 */
const WorkingWithAPIs: React.FC = () => {
  return (
    <article className="prose prose-blue max-w-none dark:prose-invert">
      <h1>Working with APIs</h1>
      
      <p>
        Learn how to integrate external APIs into your scraping workflows.
      </p>
      ...
      <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 my-6">
        ...
        <p className="mb-4">
          ...
          team if you have specific questions about Working with APIs.
        </p>
        <p>
