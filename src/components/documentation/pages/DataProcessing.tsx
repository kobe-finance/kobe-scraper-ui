...
/**
 * Data Processing documentation page
 */
const DataProcessing: React.FC = () => {
  return (
    <article className="prose prose-blue max-w-none dark:prose-invert">
      ...
      <p>
        Guide to processing, transforming, and cleaning scraped data effectively.
      </p>
      ...
      <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 my-6">
        ...
        <p className="mb-4">
          ...
          team if you have specific questions about Data Processing.
        </p>
        <p>
