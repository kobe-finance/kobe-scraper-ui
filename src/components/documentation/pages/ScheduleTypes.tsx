...
/**
 * Schedule Types documentation page
 */
const ScheduleTypes: React.FC = () => {
  return (
    <article className="prose prose-blue max-w-none dark:prose-invert">
      <h1>Schedule Types</h1>
      
      <p>
        Learn about different scheduling options for automating your scraping jobs.
      </p>
      ...
      <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 my-6">
        ...
        <p className="mb-4">
          ...
          team if you have specific questions about Schedule Types.
        </p>
        <p>
