 ...
 */
const ManagingSchedules: React.FC = () => {
  return (
    <article className="prose prose-blue max-w-none dark:prose-invert">
      <h1>Managing Schedules</h1>
      
      <p>
        Learn how to create, update, and manage scheduled jobs effectively.
      </p>
      ...
      <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 my-6">
        ...
        <p className="mb-4">
          ...
          team if you have specific questions about Managing Schedules.
        </p>
        <p>
