...
import { DevelopmentBypass } from './DevelopmentBypass';
      ...
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Web scraping made powerful, flexible, and easy
          </p>
        </div>
        
        <LoginForm />
        
        {/* Development bypass for testing - only visible in development environment */}
        {process.env.NODE_ENV === 'development' && <DevelopmentBypass />}
      </div>
    </div>
  );
};
